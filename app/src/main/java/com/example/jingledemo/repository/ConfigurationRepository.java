...
public class ConfigurationRepository {
    static final String SHARED_PREFERENCES_KEY = "com.example.t360jingledemo.repository.shared_configuration";
    static final String DOWNLOAD_DATE_FIELD = "com.example.t360jingledemo.repository.download_date";
