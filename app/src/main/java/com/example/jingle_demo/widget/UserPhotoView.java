...
public class UserPhotoView extends FrameLayout {
    ...
    private static final int COVER_RADIUS = 0;
    ...
    public void setType(final int type) {
        switch(type) {
            case TYPE_COVER:
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(displayMetrics.widthPixels, (int) (displayMetrics.widthPixels / COVER_RATIO));
                setLayoutParams(lp);
            break;
            case TYPE_NORMAL:
                ...
                photoImage.setCorners(COVER_RADIUS, COVER_RADIUS, COVER_RADIUS, COVER_RADIUS);
    ...
    public void setLoading(final boolean loading){
        ...
        photoImage.setVisibility(loading ? View.GONE : View.VISIBLE);
    }
